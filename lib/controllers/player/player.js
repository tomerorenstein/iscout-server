    ...
    dbConn.query("SELECT id as user_id FROM users WHERE username=? and password=? and type=1",
            ...
            if (err){
                ...
                if (isUserExists) {
                    ...
                    playerDAL.getPlayerInfo(results[0].user_id, function (err, results) {
...
exports.getPlayerInfo = function (request, reply) {
    ...
    // Gets current player basic info
    playerDAL.getPlayerInfo(request.query.userid, function (err, results) {
...
exports.getPlayerStatistics = function (request, reply) {
    ...
    playerDAL.getPlayerStatistics(request.query.userid, function (err, results) {
            ...
            let resJsons =
                _.map(results, (res) => {
                   return {
                       ...
                       goals: res.goals,
                       assists: res.assists,
                       game_in_starting_linup: res.game_in_starting_linup,
